...
<div class="breadcrumb-area breadcrumb-area-bg section-space--inner--80 bg-img" data-bg="assets/img/backgrounds/19.jpg"
    style="background-image: url('assets/img/backgrounds/19.jpg')">
    <div class="container">
            ...
            <div class="col-lg-12">
                <div class="feature-background__wrapper bg-img" data-bg="assets/img/backgrounds/13.jpg">
                    <div class="row g-0">
                        <div class="col-lg-5">
                            <!-- feature background -->
                            <div class="feature-background__image feature-background__image--style2 bg-img"
                                data-bg="assets/img/italia/about/aboutleft.webp"></div>
                        </div>
                        <div class="col-lg-7">
                            <!-- feature content -->
                            <div class="feature-background__content-area feature-background__content-area--style2">
                                <div class="feature-background__content-wrapper section-space--inner--50">
                                    ...
                                    <div class="section-title-area section-space--bottom--50">
                                        <h2 class="title title--style4 title--style4--about">
                                            Italia Gypsum: From Legacy to
                                            Leadership in Building Solutions
                                        </h2>
                                    </div>
                                    ...
                                    <div class="feature-background__single-content-wrapper">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <p>
                                                    Italia Gypsum started back
                                                    in 1994, thanks to the
                                                    vision of Mr. Ibrahim
                                                    Alfouzan. Over the years,
                                                    it’s grown into one of
                                                    Kuwait’s most trusted names
                                                    in gypsum and building
                                                    materials. They make a wide
                                                    range of products—like
                                                    ceiling tiles, moldings, GRG
                                                    panels, and cornices—and
                                                    also handle full design and
                                                    execution work with a team
                                                    of about 150 professionals.
                                                    They've been part of some
                                                    major projects, including
                                                    royal palaces, universities,
                                                    villas, and malls.
                                                    <br />
                                                    <br />

                                                    In 2024, Mr. Fouzan Alfouzan
                                                    took the reins and led the
                                                    company into gypsum-board
                                                    manufacturing, making Italia
                                                    Gypsum the biggest player in
                                                    that space in Kuwait.
                                                    Looking ahead, they’re
                                                    gearing up to start
                                                    cement-board production too.
                                                    It’s a company that’s built
                                                    on experience, quality, and
                ...
                <div class="col-lg-8 offset-lg-1">
                    <div class="about-list-wrapper mt-0">
                        <h3 class="about-list-title">
                            Italia manufacture and market 100% natural gypsum
                            based products for the construction industry
                            including:
                        </h3>
                        {{--
                        <p>
                            Tractor’s manufacturing capabilities are called upon
                            by the U.S. Commercial Department in 1990. During
                            the next seven years, the company had produced more
                            than 10 million tons of constructional chemicals and
                            materials.
                        </p>
                        <p>
                            Much of Tractor’s spectacular growth in the last 20
                            years resulted from the booming population and the
                            increasing needs for a place to live of the
                            citizens. We have the determination to assist our
                            people with the best facilities.
                        </p>
                        --}}
                        <div class="row">
                                ...
                                <div class="about-icon-box">
                                    <div class="about-icon-box__image">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                            ...
                                            y="0" viewBox="0 0 512 512.001" style="
                                                enable-background: new 0 0 512
                                                    512;
                                            " xml:space="preserve" class="">
                                            <g>
                                                <path
                                                    d="M256.855 178.625c7.047 0 12.754-5.71 12.754-12.754 0-7.043-5.707-12.754-12.754-12.754-56.347 0-102.027 45.68-102.027 102.031 0 56.348 45.68 102.028 102.027 102.028 56.352 0 102.032-45.68 102.032-102.028 0-7.046-5.711-12.753-12.754-12.753-7.043 0-12.754 5.707-12.754 12.753 0 42.262-34.258 76.524-76.524 76.524-42.261 0-76.523-34.262-76.523-76.524 0-42.265 34.262-76.523 76.523-76.523zm0 0"
                                                    fill="#000258" opacity="1" data-original="#000000" class=""></path>
                                                <path
                                                    d="M500.2 179.395c-2.216-6.692-9.434-10.32-16.13-8.106-6.539 2.164-10.18 9.125-8.23 15.73 38.14 121.458-29.399 250.836-150.856 288.977-121.453 38.14-250.832-29.398-288.972-150.855C-2.133 203.684 65.41 74.305 186.863 36.164a230.521 230.521 0 0 1 138.121 0c6.75 2.035 13.871-1.785 15.907-8.535 2.004-6.649-1.672-13.676-8.278-15.824C197.75-30.508 54.117 44.52 11.805 179.387-30.508 314.25 44.523 457.883 179.387 500.195c134.867 42.313 278.496-32.715 320.808-167.582a255.934 255.934 0 0 0 .004-153.218zm0 0"
                                                    fill="#000258" opacity="1" data-original="#000000" class=""></path>
                                                <path
                                                    d="M281.145 91.117c.066-7.262-5.512-13.332-12.754-13.875-3.809-.324-7.621-.648-11.532-.648-98.613 0-178.554 79.941-178.554 178.554 0 98.61 79.941 178.551 178.554 178.551 98.61 0 178.551-79.941 178.551-178.55 0-4.614-.281-9.223-.847-13.801-1.02-7-7.52-11.848-14.52-10.828-7 1.015-11.848 7.52-10.832 14.52.039.265.086.526.14.792.278 3.09.551 6.152.551 9.309.004 84.527-68.515 153.046-153.039 153.054-84.527.004-153.047-68.52-153.05-153.043-.004-84.523 68.511-153.047 153.039-153.05h.003c3.165 0 6.23.273 9.313.546l2.39.2c6.665.285 12.297-4.887 12.579-11.551.004-.063.004-.121.008-.18zm0 0"
                                                    fill="#000258" opacity="1" data-original="#000000" class=""></path>
                                                <path
                                                    d="M333.379 114.855v45.735l-85.54 85.539c-5.066 4.894-5.206 12.969-.312 18.035 4.895 5.066 12.97 5.207 18.035.313.106-.102.211-.207.313-.313l85.54-85.539h45.733c3.383 0 6.625-1.344 9.02-3.738l76.52-76.524c4.98-4.98 4.98-13.054 0-18.035a12.749 12.749 0 0 0-9.016-3.734H435.41V38.332c0-7.043-5.71-12.754-12.758-12.75a12.747 12.747 0 0 0-9.011 3.734l-76.524 76.524a12.736 12.736 0 0 0-3.738 9.015zm25.508 5.282 51.015-51.016v20.227c0 7.043 5.711 12.754 12.754 12.754h20.227l-51.016 51.015h-32.98zm0 0"
                                                    fill="#000258" opacity="1" data-original="#000000" class=""></path>
                                            </g>
                                        </svg>
                                    </div>
                                    <div class="about-icon-box__content">
                                        ...
                                        <p class="content">
                                            ...
                                            gypsum products through innovation,
                                            efficiency, and exceptional service,
                                            enhancing value for our customers
                                            and environment.
                                        </p>
                                        {{--
                                        <a href="#" class="see-more-link">SEE MORE
                            ...
                            <div class="col-md-4">
                                <div class="about-icon-box">
                                    ...
                                    <div class="about-icon-box__content">
                                        ...
                                        <p class="content">
                                            Innovating with sustainable gypsum
                                            solutions for superior quality and a
                                            greener future.
                                        </p>
                                        {{--
                                        <a href="#" class="see-more-link">SEE MORE
                            ...
                            <div class="col-md-4">
                                <div class="about-icon-box">
                                    ...
                                    <div class="about-icon-box__content">
                                        ...
                                        {{--
                                        <p class="content">
                                            We assure that our company will
                                            always keep our performance and
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="section-title-area section-space--bottom--60">
                        <div class="row">
                            <div class="col-4">
                                <img src="https://italiagypsum.com/assets/images/italia/whyitalia.png" alt=""
                                    srcset="" />
                            </div>
                            <div class="col-8">
                                <h2 class="title title--style4 section-space--bottom--30">
                                    Why
                                    <span style="font-size: 40px" class="highlight">Italia?</span>
                                </h2>
                                <p class="section-title-content section-title-content--style3">
                                    Italia Gypsum stands out in the market for
                                    several reasons:
                                    <br />
                                    <a href="#" class="see-more-link see-more-link--style2">Contact Us
                                        <i class="ion-arrow-right-c"></i></a>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row row-35">
                            ...
                            <div class="col-sm-6">
                                <div class="single-industry-grid section-space--bottom--60">
                                    ...
                                    <div class="single-industry-grid__content">
                                        Our standards rival those of
                                        multinational corporations, providing
                            ...
                            <div class="col-sm-6">
                                <div class="single-industry-grid section-space--bottom--60">
                                    <div class="single-industry-grid__heading">
                                        ...
                                        <h3 class="title">
                                            <a href="#">Prestigious Projects</a>
                                        </h3>
                                    </div>
                                    <div class="single-industry-grid__content">
                                        We have been entrusted with landmark
                                        projects, including the construction of
                                        Bayan Palace, Dar Yamama Palace, Dar
                                        Jaber, among other spectacular
                                        constructions.
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="single-industry-grid section-space--bottom--60">
                                    ...
                                    <div class="single-industry-grid__content">
                                        Our people’ wealth of knowledge,
                                        abilities, and skills contribute to the
                            ...
                            <div class="col-md-4">
                                <div class="about-box-image-single">
                                    ...
                                    <div class="about-box-image-single__content">
                                        ...
                                        <p>
                                            We lead a powerfully growing company
                                            with an evident social improving
                                            role.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="about-box-image-single">
                                    ...
                                    <div class="about-box-image-single__content">
                                        ...
                                        <p>
                                            The rewards we received are the
                                            noble compliments for what we have
                                            done.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="about-box-image-single">
                                    ...
                                    <div class="about-box-image-single__content">
                                        ...
                                        <p>
                                            We established the partnership with
                                            over 200 oversea brands and
                                            companies.
                                        </p>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="about-list-title-wrapper">
                        <div class="career-title-area section-space--bottom--50">
                            <h2 class="title">
                                Make distinctive, lasting, substantial
                            </h2>
                        </div>
                        <a href="page-contact.html" class="ht-btn ht-btn--transparent ht-btn--transparent--alt">CONTACT
                            US</a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="about-list-wrapper">
                                ...
                                <p>
                                    Our mission is to help our clients make
                        ...
                        <div class="col-md-6">
                            <div class="about-list-wrapper">
                                ...
                                <p>
                                    Our operation aligns with and forms a
