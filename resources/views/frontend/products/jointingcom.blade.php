        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm-6">
                <ul class="breadcrumb-page-list text-uppercase">
                    ...
                    <li class="has-children"><a href="#">Jointing Compound</a></li>
        ...
        <div class="col-md-7">
            <div class="feature-project-single-slide__content">
                ...
                <p class="section-title-content">
                 Made from high purity natural gypsum, All Purpose Jointing compounds are easy to mix and apply. Requires less sanding, save time and money.
                ...
                <p class="section-title-content">
                  Jointing Compound is valued in construction for enhancing thermal insulation, fire protection, soundproofing, durability, workability, and lightweight properties, used in internal/external wall finishes, fire barriers, passive fire protection coatings, acoustic treatments, and decorative plasters.
                </p>
                {{--
                <div class="section-title-area">
                    <!-- <h4 class="subtitle">Regular Plaster Boards</h4> -->
...
<div class="container mt-5">
    <div class="row ">
        <div class="col-7">
            <h2 class="text-center">Technical Specifications of Gypsum Jointing Compound</h2>
